...
public class FocusSquare: SCNNode {
	...
	public var lastPositionOnPlane: SCNVector3?
	...
	public func update(for position: SCNVector3, planeAnchor: ARPlaneAnchor?, camera: ARCamera?) {
...
internal class FocusSquareSegment: SCNNode {
