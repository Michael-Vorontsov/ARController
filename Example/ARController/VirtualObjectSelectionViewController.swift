...
class VirtualObjectSelectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		if  markLastSelection && indexPath.row == selectedVirtualObjectRow {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cellIsSelected = markLastSelection && indexPath.row == selectedVirtualObjectRow
        ...
        if var thumbnailImage = object.thumbImage {
